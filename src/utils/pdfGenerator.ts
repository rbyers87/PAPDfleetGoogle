  ...
  <body>
    ...
    <div class="content">
      <div class="field">
        ...
        <div class="field-value">${workOrder.unitNumber || 'Not specified'}</div>
      </div>

      <div class="field">
        <div class="field-label">Issue Description</div>
        <div class="field-value">${workOrder.issue || 'Not specified'}</div>
      </div>
      ...
      <div class="field">
        ...
        <div class="field-value">${workOrder.reportedBy || 'Not specified'}</div>
      </div>

      <div class="field">
        <div class="field-label">Date Created</div>
        <div class="field-value">${workOrder.createdAt || 'Not specified'}</div>
      </div>
    </div>
